...
.method public static attemptRetryOnException(Ljava/lang/String;Lcom/android/volley/Request;Lcom/android/volley/VolleyError;)V
    ...
    .line 3
    :try_start_0
    check-cast v0, Lcom/android/volley/DefaultRetryPolicy;
    ...
    .line 5
    iget v6, v0, Lcom/android/volley/DefaultRetryPolicy;->mCurrentTimeoutMs:I

    int-to-float v7, v6

    iget v8, v0, Lcom/android/volley/DefaultRetryPolicy;->mBackoffMultiplier:F
...
.method public static combineHeaders(Ljava/util/List;Lcom/android/volley/Cache$Entry;)Ljava/util/List;
    ...
    .line 10
    iget-object v2, p1, Lcom/android/volley/Header;->mName:Ljava/lang/String;
...
# virtual methods
.method public final getCacheHeaders(Lcom/android/volley/Cache$Entry;)Ljava/util/Map;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final inputStreamToBytes(Ljava/io/InputStream;I)[B
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public final logSlowRequests(JLcom/android/volley/Request;[BI)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    check-cast p2, Lcom/android/volley/DefaultRetryPolicy;

    .line 6
    iget p2, p2, Lcom/android/volley/DefaultRetryPolicy;->mCurrentRetryCount:I
...
.method public performRequest(Lcom/android/volley/Request;)Lcom/android/volley/NetworkResponse;
    ...
    invoke-virtual {v7, v0}, Lcom/android/volley/toolbox/BasicNetwork;->getCacheHeaders(Lcom/android/volley/Cache$Entry;)Ljava/util/Map;
    ...
    .line 5
    :try_start_1
    iget v14, v12, Lcom/android/volley/toolbox/HttpResponse;->mStatusCode:I

    .line 6
    iget-object v0, v12, Lcom/android/volley/toolbox/HttpResponse;->mHeaders:Ljava/util/List;
    ...
    :cond_1
    :try_start_3
    iget-object v0, v12, Lcom/android/volley/toolbox/HttpResponse;->mContent:Ljava/io/InputStream;
    :try_end_3
    ...
    .line 14
    :try_start_4
    iget v1, v12, Lcom/android/volley/toolbox/HttpResponse;->mContentLength:I

    .line 15
    invoke-virtual {v7, v0, v1}, Lcom/android/volley/toolbox/BasicNetwork;->inputStreamToBytes(Ljava/io/InputStream;I)[B
    ...
    .line 17
    invoke-virtual/range {v1 .. v6}, Lcom/android/volley/toolbox/BasicNetwork;->logSlowRequests(JLcom/android/volley/Request;[BI)V
    ...
    .line 21
    iget v0, v2, Lcom/android/volley/toolbox/HttpResponse;->mStatusCode:I
