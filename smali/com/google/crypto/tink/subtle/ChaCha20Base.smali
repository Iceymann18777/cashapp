...
.method public decrypt(Ljava/nio/ByteBuffer;)[B
    ...
    .line 8
    iget v5, p0, Lcom/google/crypto/tink/subtle/ChaCha20Base;->initialCounter:I

    add-int/2addr v5, v4

    invoke-virtual {p0, v0, v5}, Lcom/google/crypto/tink/subtle/ChaCha20Base;->chacha20Block([BI)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v1, p1, v5, v6}, Lcom/google/android/material/R$style;->xor(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;I)V

    goto :goto_1

    .line 10
    :cond_0
    invoke-static {v1, p1, v5, v7}, Lcom/google/android/material/R$style;->xor(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;I)V
