...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v2, v2}, Lcom/google/android/libraries/places/internal/zzmp;-><init>(Ljava/lang/String;II)V

    sput-object v0, Lcom/google/android/libraries/places/internal/zzmp;->zza:Lcom/google/android/libraries/places/internal/zzmp;

    .line 2
    new-instance v1, Lcom/google/android/libraries/places/internal/zzmp;

    const-string v3, "ENTER"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4, v4}, Lcom/google/android/libraries/places/internal/zzmp;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/google/android/libraries/places/internal/zzmp;->zzb:Lcom/google/android/libraries/places/internal/zzmp;

    .line 3
    new-instance v3, Lcom/google/android/libraries/places/internal/zzmp;

    const-string v5, "EXIT"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6, v6}, Lcom/google/android/libraries/places/internal/zzmp;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/google/android/libraries/places/internal/zzmp;->zzc:Lcom/google/android/libraries/places/internal/zzmp;

    .line 4
    new-instance v5, Lcom/google/android/libraries/places/internal/zzmp;

    const-string v7, "DWELL_DEPRECATED"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8, v8}, Lcom/google/android/libraries/places/internal/zzmp;-><init>(Ljava/lang/String;II)V

    sput-object v5, Lcom/google/android/libraries/places/internal/zzmp;->zzd:Lcom/google/android/libraries/places/internal/zzmp;

    .line 5
    new-instance v7, Lcom/google/android/libraries/places/internal/zzmp;

    const-string v9, "DWELL"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10, v10}, Lcom/google/android/libraries/places/internal/zzmp;-><init>(Ljava/lang/String;II)V

    sput-object v7, Lcom/google/android/libraries/places/internal/zzmp;->zze:Lcom/google/android/libraries/places/internal/zzmp;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/google/android/libraries/places/internal/zzmp;
    ...
    .line 6
    sput-object v9, Lcom/google/android/libraries/places/internal/zzmp;->zzh:[Lcom/google/android/libraries/places/internal/zzmp;
