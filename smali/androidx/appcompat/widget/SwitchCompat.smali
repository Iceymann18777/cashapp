...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v6, p1, v5}, Landroidx/appcompat/widget/TintTypedArray;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    const/4 v5, 0x2

    .line 18
    invoke-virtual {v6, v5}, Landroidx/appcompat/widget/TintTypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 22
    :cond_1
    invoke-virtual {v6, v2}, Landroidx/appcompat/widget/TintTypedArray;->getText(I)Ljava/lang/CharSequence;

    move-result-object v7

    iput-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->mTextOn:Ljava/lang/CharSequence;

    .line 23
    invoke-virtual {v6, v4}, Landroidx/appcompat/widget/TintTypedArray;->getText(I)Ljava/lang/CharSequence;

    move-result-object v7

    iput-object v7, p0, Landroidx/appcompat/widget/SwitchCompat;->mTextOff:Ljava/lang/CharSequence;

    const/4 v7, 0x3

    .line 24
    invoke-virtual {v6, v7, v4}, Landroidx/appcompat/widget/TintTypedArray;->getBoolean(IZ)Z
    ...
    .line 25
    invoke-virtual {v6, v8, v2}, Landroidx/appcompat/widget/TintTypedArray;->getDimensionPixelSize(II)I
    ...
    .line 28
    invoke-virtual {v6, v8, v2}, Landroidx/appcompat/widget/TintTypedArray;->getBoolean(IZ)Z
    ...
    .line 32
    invoke-virtual {v6, v8, v9}, Landroidx/appcompat/widget/TintTypedArray;->getInt(II)I
    ...
    .line 49
    invoke-virtual {v6, v8, v2}, Landroidx/appcompat/widget/TintTypedArray;->getResourceId(II)I
    ...
    .line 54
    invoke-static {p1, v10}, Landroidx/appcompat/content/res/AppCompatResources;->getColorStateList(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->mSwitchTransformationMethod:Landroid/text/method/TransformationMethod;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/SwitchCompat;->mTextHelper:Landroidx/appcompat/widget/AppCompatTextHelper;

    .line 81
    invoke-virtual {v1, p2, v0}, Landroidx/appcompat/widget/AppCompatTextHelper;->loadFromAttributes(Landroid/util/AttributeSet;I)V

    .line 82
    iget-object p2, v6, Landroidx/appcompat/widget/TintTypedArray;->mWrapped:Landroid/content/res/TypedArray;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 6
    invoke-virtual {p0}, Landroidx/appcompat/widget/SwitchCompat;->getThumbOffset()I
...
.method public final getThumbOffset()I
    .locals 2
