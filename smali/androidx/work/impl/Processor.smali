...
.method public static interrupt(Ljava/lang/String;Landroidx/work/impl/WorkerWrapper;)Z
    ...
    .line 3
    iget-object v2, p1, Landroidx/work/impl/WorkerWrapper;->mInnerFuture:Lcom/google/common/util/concurrent/ListenableFuture;

    if-eqz v2, :cond_0

    .line 4
    check-cast v2, Landroidx/work/impl/utils/futures/AbstractFuture;

    invoke-virtual {v2}, Landroidx/work/impl/utils/futures/AbstractFuture;->isDone()Z

    move-result v2

    .line 5
    iget-object v3, p1, Landroidx/work/impl/WorkerWrapper;->mInnerFuture:Lcom/google/common/util/concurrent/ListenableFuture;

    check-cast v3, Landroidx/work/impl/utils/futures/AbstractFuture;

    invoke-virtual {v3, v0}, Landroidx/work/impl/utils/futures/AbstractFuture;->cancel(Z)Z
    ...
    .line 6
    :goto_0
    iget-object v3, p1, Landroidx/work/impl/WorkerWrapper;->mWorker:Landroidx/work/ListenableWorker;
    ...
    invoke-virtual {v2, v3, p1, v4}, Landroidx/work/Logger;->debug(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
...
.method public startWork(Ljava/lang/String;Landroidx/work/WorkerParameters$RuntimeExtras;)Z
    ...
    .line 8
    iput-object v4, v1, Landroidx/work/impl/WorkerWrapper$Builder;->mSchedulers:Ljava/util/List;

    if-eqz p2, :cond_1

    .line 9
    iput-object p2, v1, Landroidx/work/impl/WorkerWrapper$Builder;->mRuntimeExtras:Landroidx/work/WorkerParameters$RuntimeExtras;
    ...
    .line 11
    iget-object v1, p2, Landroidx/work/impl/WorkerWrapper;->mFuture:Landroidx/work/impl/utils/futures/SettableFuture;
    ...
    .line 14
    iget-object v5, v5, Landroidx/work/impl/utils/taskexecutor/WorkManagerTaskExecutor;->mMainThreadExecutor:Ljava/util/concurrent/Executor;
