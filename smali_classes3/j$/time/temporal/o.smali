.class final enum Lj$/time/temporal/o;
...
.method public I(Lj$/time/temporal/Temporal;J)Lj$/time/temporal/Temporal;
    ...
    invoke-virtual {p0}, Lj$/time/temporal/o;->p()Lj$/time/temporal/B;

    move-result-object v0

    invoke-virtual {v0, p2, p3, p0}, Lj$/time/temporal/B;->b(JLj$/time/temporal/w;)J

    invoke-virtual {p0, p1}, Lj$/time/temporal/o;->w(Lj$/time/temporal/TemporalAccessor;)J

    move-result-wide v0

    invoke-static {p2, p3, v0, v1}, Lj$/l;->a(JJ)J
...
.method public J(Lj$/time/temporal/TemporalAccessor;)Lj$/time/temporal/B;
    ...
    invoke-virtual {p0, p1}, Lj$/time/temporal/o;->H(Lj$/time/temporal/TemporalAccessor;)Z
    ...
    invoke-static {p1}, Lj$/time/temporal/q;->N(Lj$/time/LocalDate;)Lj$/time/temporal/B;
...
.method public T(Ljava/util/Map;Lj$/time/temporal/TemporalAccessor;Lj$/time/format/H;)Lj$/time/chrono/c;
    ...
    sget-object v3, Lj$/time/temporal/q;->d:Lj$/time/temporal/q;
    ...
    sget-object v5, Lj$/time/temporal/j;->t:Lj$/time/temporal/j;
    ...
    check-cast v7, Lj$/time/temporal/p;

    invoke-virtual {v7}, Lj$/time/temporal/p;->p()Lj$/time/temporal/B;
    ...
    invoke-virtual {v7, v8, v9, v3}, Lj$/time/temporal/B;->a(JLj$/time/temporal/w;)I

    move-result v4

    sget-object v7, Lj$/time/temporal/q;->c:Lj$/time/temporal/q;
    ...
    invoke-static/range {p2 .. p2}, Lj$/time/temporal/q;->M(Lj$/time/temporal/TemporalAccessor;)V

    const/4 v9, 0x1

    const/4 v10, 0x4

    invoke-static {v4, v9, v10}, Lj$/time/LocalDate;->T(III)Lj$/time/LocalDate;

    move-result-object v4

    sget-object v9, Lj$/time/format/H;->c:Lj$/time/format/H;
    ...
    invoke-static {v12, v13, v14, v15}, Lj$/l;->a(JJ)J
    ...
    :cond_2
    :goto_1
    invoke-static {v7, v8, v9, v10}, Lj$/l;->a(JJ)J
    ...
    invoke-virtual {v2, v5, v12, v13}, Lj$/time/LocalDate;->c0(Lj$/time/temporal/w;J)Lj$/time/LocalDate;
    ...
    invoke-virtual {v5, v11, v12}, Lj$/time/temporal/j;->L(J)I
    ...
    invoke-static {v4}, Lj$/time/temporal/q;->N(Lj$/time/LocalDate;)Lj$/time/temporal/B;
    ...
    :cond_6
    invoke-virtual/range {p0 .. p0}, Lj$/time/temporal/o;->p()Lj$/time/temporal/B;

    move-result-object v2

    :goto_4
    invoke-virtual {v2, v7, v8, v0}, Lj$/time/temporal/B;->b(JLj$/time/temporal/w;)J
    ...
    invoke-virtual {v2, v5, v6, v7}, Lj$/time/LocalDate;->c0(Lj$/time/temporal/w;J)Lj$/time/LocalDate;
...
.method public bridge synthetic r(Ljava/util/Map;Lj$/time/temporal/TemporalAccessor;Lj$/time/format/H;)Lj$/time/temporal/TemporalAccessor;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/temporal/o;->T(Ljava/util/Map;Lj$/time/temporal/TemporalAccessor;Lj$/time/format/H;)Lj$/time/chrono/c;
...
.method public w(Lj$/time/temporal/TemporalAccessor;)J
    ...
    invoke-static {p1}, Lj$/time/temporal/q;->O(Lj$/time/LocalDate;)I
