...
.method public e(Lj$/time/format/B;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {p1}, Lj$/time/format/B;->g()V
    ...
    invoke-interface {v5, p1, p2}, Lj$/time/format/g;->e(Lj$/time/format/B;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {p1}, Lj$/time/format/B;->a()V
...
.method public j(Lj$/time/format/y;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {p1}, Lj$/time/format/y;->r()V
    ...
    invoke-interface {v5, p1, p2, v4}, Lj$/time/format/g;->j(Lj$/time/format/y;Ljava/lang/CharSequence;I)I

    move-result v4

    if-gez v4, :cond_0

    invoke-virtual {p1, v1}, Lj$/time/format/y;->f(Z)V
    ...
    invoke-virtual {p1, p2}, Lj$/time/format/y;->f(Z)V
    ...
    invoke-interface {v3, p1, p2, p3}, Lj$/time/format/g;->j(Lj$/time/format/y;Ljava/lang/CharSequence;I)I
