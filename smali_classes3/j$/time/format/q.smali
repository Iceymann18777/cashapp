...
.method constructor <init>(Lj$/time/temporal/w;IIILj$/time/chrono/c;)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v6}, Lj$/time/format/q;-><init>(Lj$/time/temporal/w;IIILj$/time/chrono/c;I)V
...
.method private constructor <init>(Lj$/time/temporal/w;IIILj$/time/chrono/c;I)V
    .locals 6

    sget-object v4, Lj$/time/format/I;->c:Lj$/time/format/I;
...
.method synthetic constructor <init>(Lj$/time/temporal/w;IIILj$/time/chrono/c;ILj$/time/format/c;)V
    .locals 0

    invoke-direct/range {p0 .. p6}, Lj$/time/format/q;-><init>(Lj$/time/temporal/w;IIILj$/time/chrono/c;I)V
...
.method b(Lj$/time/format/B;J)J
    ...
    iget-object v3, p0, Lj$/time/format/q;->h:Lj$/time/chrono/c;
    ...
    invoke-interface {p1, v2}, Lj$/time/chrono/j;->q(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/c;
...
.method d(Lj$/time/format/y;JII)I
    ...
    invoke-interface {v0, v1}, Lj$/time/chrono/j;->q(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/c;

    move-result-object v0

    iget-object v1, p0, Lj$/time/format/l;->a:Lj$/time/temporal/w;

    invoke-interface {v0, v1}, Lj$/time/temporal/TemporalAccessor;->j(Lj$/time/temporal/w;)I
    ...
    invoke-direct/range {v1 .. v7}, Lj$/time/format/b;-><init>(Lj$/time/format/q;Lj$/time/format/y;JII)V

    invoke-virtual {p1, v8}, Lj$/time/format/y;->a(Lj$/util/function/Consumer;)V
...
.method f()Lj$/time/format/l;
    ...
    invoke-direct/range {v2 .. v8}, Lj$/time/format/q;-><init>(Lj$/time/temporal/w;IIILj$/time/chrono/c;I)V
