...
.method public static H(Lj$/time/temporal/TemporalAccessor;)Lj$/time/ZoneId;
    .locals 3
...
.method public static J(Ljava/lang/String;Lj$/time/j;)Lj$/time/ZoneId;
    .locals 2
    ...
    invoke-virtual {p1}, Lj$/time/j;->n()Ljava/lang/String;
    ...
    .line 4
    invoke-direct {v0, p0, p1}, Lj$/time/k;-><init>(Ljava/lang/String;Lj$/time/m/c;)V

    return-object v0
.end method

.method private static L(Ljava/lang/String;IZ)Lj$/time/ZoneId;
    .locals 3
    ...
    sget-object p0, Lj$/time/j;->f:Lj$/time/j;

    invoke-static {v0, p0}, Lj$/time/ZoneId;->J(Ljava/lang/String;Lj$/time/j;)Lj$/time/ZoneId;
    ...
    invoke-static {p0, p2}, Lj$/time/k;->M(Ljava/lang/String;Z)Lj$/time/k;
    ...
    invoke-static {p1}, Lj$/time/j;->O(Ljava/lang/String;)Lj$/time/j;

    move-result-object p1

    sget-object p2, Lj$/time/j;->f:Lj$/time/j;

    if-ne p1, p2, :cond_2

    invoke-static {v0, p1}, Lj$/time/ZoneId;->J(Ljava/lang/String;Lj$/time/j;)Lj$/time/ZoneId;
    ...
    invoke-direct {p2, p0, p1}, Lj$/time/c;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static of(Ljava/lang/String;)Lj$/time/ZoneId;
    ...
    :cond_2
    invoke-static {p0, v1}, Lj$/time/k;->M(Ljava/lang/String;Z)Lj$/time/k;
    ...
    :goto_1
    invoke-static {p0, v0, v1}, Lj$/time/ZoneId;->L(Ljava/lang/String;IZ)Lj$/time/ZoneId;
    ...
    :cond_4
    :goto_2
    invoke-static {p0}, Lj$/time/j;->O(Ljava/lang/String;)Lj$/time/j;
...
# virtual methods
.method public abstract I()Lj$/time/m/c;
.end method
