...
# direct methods
.method constructor <init>(Lj$/util/stream/l3;)V
    .locals 0
...
# virtual methods
.method protected final a(Ljava/util/Deque;)Lj$/util/stream/l3;
    .locals 6
    ...
    invoke-interface {v0}, Lj$/util/stream/l3;->o()I
    ...
    invoke-interface {v0, v1}, Lj$/util/stream/l3;->b(I)Lj$/util/stream/l3;
...
.method public final estimateSize()J
    ...
    :cond_1
    iget v0, p0, Lj$/util/stream/R3;->b:I

    :goto_0
    iget-object v3, p0, Lj$/util/stream/R3;->a:Lj$/util/stream/l3;

    invoke-interface {v3}, Lj$/util/stream/l3;->o()I
    ...
    invoke-interface {v3, v0}, Lj$/util/stream/l3;->b(I)Lj$/util/stream/l3;
...
.method protected final f()Ljava/util/Deque;
    ...
    iget-object v1, p0, Lj$/util/stream/R3;->a:Lj$/util/stream/l3;

    invoke-interface {v1}, Lj$/util/stream/l3;->o()I
    ...
    :goto_0
    iget v2, p0, Lj$/util/stream/R3;->b:I

    if-lt v1, v2, :cond_0

    iget-object v2, p0, Lj$/util/stream/R3;->a:Lj$/util/stream/l3;

    invoke-interface {v2, v1}, Lj$/util/stream/l3;->b(I)Lj$/util/stream/l3;
...
.method protected final g()Z
    ...
    iput-object v0, p0, Lj$/util/stream/R3;->e:Ljava/util/Deque;
    ...
    iput-object v0, p0, Lj$/util/stream/R3;->a:Lj$/util/stream/l3;
...
.method public bridge synthetic trySplit()Lj$/util/B;
    ...
    invoke-virtual {p0}, Lj$/util/stream/R3;->trySplit()Lj$/util/Spliterator;
...
.method public final trySplit()Lj$/util/Spliterator;
    ...
    iget-object v1, p0, Lj$/util/stream/R3;->d:Lj$/util/Spliterator;
    ...
    :cond_1
    iget v1, p0, Lj$/util/stream/R3;->b:I
    ...
    iput v2, p0, Lj$/util/stream/R3;->b:I
    ...
    iput-object v0, p0, Lj$/util/stream/R3;->c:Lj$/util/Spliterator;
    ...
    iput v0, p0, Lj$/util/stream/R3;->b:I

    iget-object v1, p0, Lj$/util/stream/R3;->a:Lj$/util/stream/l3;

    iput v2, p0, Lj$/util/stream/R3;->b:I

    invoke-interface {v1, v0}, Lj$/util/stream/l3;->b(I)Lj$/util/stream/l3;
