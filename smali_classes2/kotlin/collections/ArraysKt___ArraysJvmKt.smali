...
.method public static final access$reverseElementIndex(Ljava/util/List;I)I
    ...
    .line 1
    invoke-static {p0}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->getLastIndex(Ljava/util/List;)I
...
.method public static binarySearch$default(Ljava/util/List;Ljava/lang/Comparable;III)I
    .locals 2
    ...
    :cond_1
    const-string p4, "$this$binarySearch"
    ...
    .line 5
    invoke-static {v0, p1}, Lio/reactivex/plugins/RxJavaPlugins;->compareValues(Ljava/lang/Comparable;Ljava/lang/Comparable;)I
    ...
    invoke-static {v1, p2, p1}, Lcom/android/tools/r8/GeneratedOutlineSupport;->outline47(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method public static final contains(Ljava/lang/Iterable;Ljava/lang/Object;)Z
    ...
    .line 3
    :cond_0
    invoke-static {p0, p1}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->indexOf(Ljava/lang/Iterable;Ljava/lang/Object;)I
...
.method public static synthetic copyInto$default([B[BIIII)[B
    .locals 2
...
.method public static synthetic copyInto$default([Ljava/lang/Object;[Ljava/lang/Object;IIII)[Ljava/lang/Object;
    .locals 2
...
.method public static final copyOfRange([Ljava/lang/Object;II)[Ljava/lang/Object;
    ...
    invoke-static {p2, v0}, Lio/reactivex/plugins/RxJavaPlugins;->copyOfRangeToIndexCheck(II)V
...
.method public static final distinct(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    .line 1
    invoke-static {p0}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->toMutableSet(Ljava/lang/Iterable;)Ljava/util/Set;
...
.method public static final drop(Ljava/lang/Iterable;I)Ljava/util/List;
    ...
    .line 5
    invoke-static {p0}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->last(Ljava/lang/Iterable;)Ljava/lang/Object;
    ...
    .line 16
    :cond_9
    invoke-static {v1}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->optimizeReadOnlyList(Ljava/util/List;)Ljava/util/List;
...
.method public static final dropLast(Ljava/util/List;I)Ljava/util/List;
    ...
    :goto_1
    invoke-static {p0, v0}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->take(Ljava/lang/Iterable;I)Ljava/util/List;
...
.method public static synthetic fill$default([Ljava/lang/Object;Ljava/lang/Object;III)V
    .locals 1
...
.method public static final intersect(Ljava/lang/Iterable;Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    .line 3
    invoke-static {p1, p0}, Lio/reactivex/plugins/RxJavaPlugins;->convertToSetForSetOperationWith(Ljava/lang/Iterable;Ljava/lang/Iterable;)Ljava/util/Collection;
...
.method public static synthetic joinTo$default(Ljava/lang/Iterable;Ljava/lang/Appendable;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILjava/lang/CharSequence;Lkotlin/jvm/functions/Function1;I)Ljava/lang/Appendable;
    .locals 9
    ...
    .line 1
    invoke-static/range {v1 .. v8}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->joinTo(Ljava/lang/Iterable;Ljava/lang/Appendable;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILjava/lang/CharSequence;Lkotlin/jvm/functions/Function1;)Ljava/lang/Appendable;
...
.method public static synthetic joinToString$default(Ljava/lang/Iterable;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILjava/lang/CharSequence;Lkotlin/jvm/functions/Function1;I)Ljava/lang/String;
    .locals 7
    ...
    .line 1
    invoke-static/range {v0 .. v6}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->joinToString(Ljava/lang/Iterable;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILjava/lang/CharSequence;Lkotlin/jvm/functions/Function1;)Ljava/lang/String;
...
.method public static final varargs mapOf([Lkotlin/Pair;)Ljava/util/Map;
    ...
    .line 3
    invoke-static {v0, p0}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->putAll(Ljava/util/Map;[Lkotlin/Pair;)V
...
.method public static final minus(Ljava/util/Map;Ljava/lang/Object;)Ljava/util/Map;
    ...
    .line 10
    invoke-static {p0}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->toMutableMap(Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-interface {p0, p1}, Ljava/util/Map;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {p0}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->optimizeReadOnlyMap(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final optimizeReadOnlyMap(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 2
    :cond_0
    invoke-static {p0}, Lio/reactivex/plugins/RxJavaPlugins;->toSingletonMap(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final plus(Ljava/lang/Iterable;Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {p0, p1}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->plus(Ljava/util/Collection;Ljava/lang/Object;)Ljava/util/List;
    ...
    .line 21
    invoke-static {v0, p0}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->addAll(Ljava/util/Collection;Ljava/lang/Iterable;)Z
...
.method public static final plus(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/List;
    ...
    .line 31
    invoke-static {v0, p1}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->addAll(Ljava/util/Collection;Ljava/lang/Iterable;)Z
...
.method public static final plus(Ljava/util/Map;Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p1}, Lio/reactivex/plugins/RxJavaPlugins;->mapOf(Lkotlin/Pair;)Ljava/util/Map;
...
.method public static final plus(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    .line 5
    invoke-static {v1, p1}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->addAll(Ljava/util/Collection;Ljava/lang/Iterable;)Z
...
.method public static final reversed(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    .line 2
    :cond_0
    invoke-static {p0}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->toMutableList(Ljava/lang/Iterable;)Ljava/util/List;
...
.method public static final varargs setOf([Ljava/lang/Object;)Ljava/util/Set;
    ...
    invoke-static {p0}, Lio/reactivex/plugins/RxJavaPlugins;->toSet([Ljava/lang/Object;)Ljava/util/Set;
...
.method public static final single(Ljava/lang/Iterable;)Ljava/lang/Object;
    ...
    invoke-static {p0}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->single(Ljava/util/List;)Ljava/lang/Object;
...
.method public static final sortedWith(Ljava/lang/Iterable;Ljava/util/Comparator;)Ljava/util/List;
    ...
    invoke-static {p0, p1}, Lio/reactivex/plugins/RxJavaPlugins;->sortWith(Ljava/util/List;Ljava/util/Comparator;)V
...
.method public static final take(Ljava/lang/Iterable;I)Ljava/util/List;
    ...
    .line 8
    :cond_5
    invoke-static {v2}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->optimizeReadOnlyList(Ljava/util/List;)Ljava/util/List;
...
.method public static final toHashSet(Ljava/lang/Iterable;)Ljava/util/HashSet;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->toCollection(Ljava/lang/Iterable;Ljava/util/Collection;)Ljava/util/Collection;
...
.method public static final toList(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-static {p0}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->optimizeReadOnlyList(Ljava/util/List;)Ljava/util/List;
...
.method public static final toMap(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->toMap(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lio/reactivex/plugins/RxJavaPlugins;->mapOf(Lkotlin/Pair;)Ljava/util/Map;
...
.method public static final toSet(Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    invoke-static {p0, v1}, Lkotlin/collections/ArraysKt___ArraysJvmKt;->toCollection(Ljava/lang/Iterable;Ljava/util/Collection;)Ljava/util/Collection;
...
.method public static final windowed(Ljava/lang/Iterable;IIZ)Ljava/util/List;
    ...
    .line 1
    invoke-static {p1, p2}, Lio/reactivex/plugins/RxJavaPlugins;->checkWindowSizeStep(II)V
    ...
    invoke-static {p0}, Lkotlin/reflect/jvm/internal/impl/types/typeUtil/TypeUtilsKt;->iterator(Lkotlin/jvm/functions/Function2;)Ljava/util/Iterator;
...
.method public static final zip(Ljava/lang/Iterable;Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-static {p0, v3}, Lio/reactivex/plugins/RxJavaPlugins;->collectionSizeOrDefault(Ljava/lang/Iterable;I)I
